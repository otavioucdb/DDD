...
-- Carga de Reservas
insert into Reserva(id, hospede_id, quarto_id, dataCheckin, dataCheckout, emAberto) values (1, 3, 10, '2009-09-18 00:00:00.000', '2009-09-19 23:59:59.999', false);
insert into Reserva(id, hospede_id, quarto_id, dataCheckin, dataCheckout, emAberto) values (2, 3, 10, '2009-12-05 00:00:00.000', '2009-12-07 00:00:00.000', true);
insert into Reserva(id, hospede_id, quarto_id, dataCheckin, dataCheckout, emAberto) values (3, 2, 9, '2009-12-10 00:00:00.000', '2009-12-11 00:00:00.000', true);
insert into Reserva(id, hospede_id, quarto_id, dataCheckin, dataCheckout, emAberto) values (4, 2, 10, '2009-12-05 00:00:00.000', '2009-12-07 00:00:00.000', true);
